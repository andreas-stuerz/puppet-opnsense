  ...
  def _translate_json_list_item_to_puppet_resource(device, json_list_item)
    {
      ...
      bind: json_list_item['bind'],
      bind_options: json_list_item['bindOptions'],
      mode: json_list_item['mode'],
      default_backend: json_list_item['defaultBackend'],
      ssl_enabled: bool_from_value(json_list_item['ssl_enabled']),
      ssl_certificates: array_from_value(json_list_item['ssl_certificates']),
      ssl_default_certificate: json_list_item['ssl_default_certificate'],
      ssl_custom_options: json_list_item['ssl_customOptions'],
      ssl_advanced_enabled: bool_from_value(json_list_item['ssl_advancedEnabled']),
      ssl_bind_options: array_from_value(json_list_item['ssl_bindOptions']),
      ssl_min_version: json_list_item['ssl_minVersion'],
      ssl_max_version: json_list_item['ssl_maxVersion'],
      ssl_cipher_list: json_list_item['ssl_cipherList'],
      ssl_cipher_suites: json_list_item['ssl_cipherSuites'],
      ssl_hsts_enabled: bool_from_value(json_list_item['ssl_hstsEnabled']),
      ssl_hsts_include_sub_domains: bool_from_value(json_list_item['ssl_hstsIncludeSubDomains']),
      ssl_hsts_preload: bool_from_value(json_list_item['ssl_hstsPreload']),
      ssl_hsts_max_age: json_list_item['ssl_hstsMaxAge'],
      ssl_client_auth_enabled: bool_from_value(json_list_item['ssl_clientAuthEnabled']),
      ssl_client_auth_verify: json_list_item['ssl_clientAuthVerify'],
      ssl_client_auth_cas: array_from_value(json_list_item['ssl_clientAuthCAs']),
      ssl_client_auth_crls: array_from_value(json_list_item['ssl_clientAuthCRLs']),
      basic_auth_enabled: bool_from_value(json_list_item['basicAuthEnabled']),
      basic_auth_users: array_from_value(json_list_item['basicAuthUsers']),
      basic_auth_groups: array_from_value(json_list_item['basicAuthGroups']),
      tuning_max_connections: json_list_item['tuning_maxConnections'],
      tuning_timeout_client: json_list_item['tuning_timeoutClient'],
      tuning_timeout_http_req: json_list_item['tuning_timeoutHttpReq'],
      tuning_timeout_http_keep_alive: json_list_item['tuning_timeoutHttpKeepAlive'],
      linked_cpu_affinity_rules: array_from_value(json_list_item['linkedCpuAffinityRules']),
      logging_dont_log_null: bool_from_value(json_list_item['logging_dontLogNull']),
      logging_dont_log_normal: bool_from_value(json_list_item['logging_dontLogNormal']),
      logging_log_separate_errors: bool_from_value(json_list_item['logging_logSeparateErrors']),
      logging_detailed_log: bool_from_value(json_list_item['logging_detailedLog']),
      logging_socket_stats: bool_from_value(json_list_item['logging_socketStats']),
      stickiness_pattern: json_list_item['stickiness_pattern'],
      stickiness_data_types: array_from_value(json_list_item['stickiness_dataTypes']),
      stickiness_expire: json_list_item['stickiness_expire'],
      stickiness_size: json_list_item['stickiness_size'],
      stickiness_counter: bool_from_value(json_list_item['stickiness_counter']),
      stickiness_counter_key: json_list_item['stickiness_counter_key'],
      stickiness_length: json_list_item['stickiness_length'],
      ...
      advertised_protocols: array_from_value(json_list_item['advertised_protocols']),
      forward_for: bool_from_value(json_list_item['forwardFor']),
      connection_behaviour: json_list_item['connectionBehaviour'],
      custom_options: json_list_item['customOptions'],
      linked_actions: array_from_value(json_list_item['linkedActions']),
      linked_errorfiles: array_from_value(json_list_item['linkedErrorfiles']),
      ensure: 'present',
    }
  end

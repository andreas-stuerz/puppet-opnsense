    ...
    [
      {
        "id": '6142ed9181bc82.06337290',
          ...
          "proxyProtocol": '',
          "linkedServers": [],
          "linkedResolver": '229fd0ad-e069-452c-8854-7afe30c5f289',
          "resolverOpts": '',
          "resolvePrefer": '',
          "source": '',
          "healthCheckEnabled": '1',
          ...
          "healthCheckFall": '',
          "healthCheckRise": '',
          "linkedMailer": '339fd0ad-e069-452c-8854-7afe30c5f289',
          "http2Enabled": '1',
          "http2Enabled_nontls": '1',
          ...
          "basicAuthGroups": '119fd0ad-e069-452c-8854-7afe30c5f289',
          "tuning_timeoutConnect": '',
          "tuning_timeoutCheck": '',
          "tuning_timeoutServer": '',
          "tuning_retries": '',
      ...
      expect(provider.get(context, [])).to eq [
        {
          title: 'pool4@opnsense1.example.com',
            ...
            random_draws: '2',
            proxy_protocol: '',
            linked_servers: ['server1'],
            linked_resolver: '',
            resolver_opts: [],
            resolve_prefer: '',
            source: '',
            health_check_enabled: true,
            health_check: 'http_80',
